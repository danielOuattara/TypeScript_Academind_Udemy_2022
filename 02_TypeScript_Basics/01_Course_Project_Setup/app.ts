...
let number1: number = 5; // Not useful & redondant: type inference already does the job
...
let number2: number;
number2 = 2.5 // Good V
number2 = "2.5" // Incorrect  X
const printResult = true;

const resultPhrase_0 = "The result is : "; 
console.log(typeof resultPhrase_0) // string

let resultPhrase = "The result is : "; // type automatically recognized as string
resultPhrase = 23 // Incorrect
